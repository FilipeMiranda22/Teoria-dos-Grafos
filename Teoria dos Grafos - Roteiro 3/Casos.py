...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Grafos para testar DFS e Ciclo
        ...
        self.g16 = Grafo(['A', 'B', 'C', 'D', 'E', 'F'], {'a0': 'D-A', 'a1': 'A-B', 'a2': 'B-C', 'a3': 'C-A', 'a4': 'D-E',
                                                     'a5': 'D-F'})  # Triangulo com 2 pontas
        self.g17 = Grafo(['A', 'B', 'C'],
                    {'a1': 'A-B', 'a2': 'A-B', 'a3': 'A-C', 'a4': 'A-C'})  # Grafo somente com paralelas
        self.g18 = Grafo(('A', 'B', 'C'), {'a1': 'A-B', 'a2': 'A-C'})  # Arvore simples
        self.g19 = Grafo(('A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'),
                    {'a1': 'A-B', 'a2': 'A-C', 'a3': 'D-E', 'a4': 'E-F', 'a5': 'F-G', 'a6': 'G-D',
                     'a7': 'A-H'})  # NÃO CONEXO COM CICLO EM UM SUB GRAFO
        self.g20 = Grafo(('A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K'),
    ...
    def test_ha_ciclo(self):
        self.assertEqual(set(self.g15.ha_ciclo()), set(['A', 'a1', 'B', 'a2', 'C', 'a3', 'A']))
        self.assertEqual(set(self.g16.ha_ciclo()), set(['A', 'a1', 'B', 'a2', 'C', 'a3', 'A']))
        self.assertEqual(set(self.g17.ha_ciclo()), set(['A', 'a1', 'B', 'a2', 'A']))
        self.assertEqual(self.g18.ha_ciclo(), -1)
        self.assertEqual(set(self.g19.ha_ciclo()), set(['D', 'a3', 'E', 'a4', 'F', 'a5', 'G', 'a6', 'D']))
        self.assertEqual(set(self.g20.ha_ciclo()), set(['I', 'a8', 'J', 'a9', 'K', 'a10', 'I']))
        self.assertEqual(set(self.g1.ha_ciclo()), set(['C', 'a2', 'E', 'a3', 'C']))
        self.assertEqual(set(self.g2.ha_ciclo()), set(['A', '1', 'B', '11', 'F', '10', 'H', '9', 'G', '2', 'A']))
        self.assertEqual(set(self.g3.ha_ciclo()), set(['B', '2', 'B']))
        self.assertEqual(set(self.g11.ha_ciclo()), set(['A', '1', 'A']))
        self.assertEqual(set(self.g6.ha_ciclo()), set(['A', 'a1', 'D', 'a3', 'B', 'a4', 'E', 'a2', 'A']))
        self.assertEqual(set(self.g13.ha_ciclo()), set(['V1', 'a1', 'V2', 'a2', 'V3', 'a3', 'V4', 'a4', 'V1']))

    def test_caminho(self):
        self.assertEqual(set(self.g1.caminho(4)), set(['J', 'a1', 'C', 'a6', 'M', 'a8', 'T', 'a9', 'Z']))
        self.assertEqual(set(self.g2.caminho(6)), set(['A', '3', 'J', '7', 'I', '8', 'G', '9', 'H', '10', 'F', '11', 'B']))
        self.assertFalse(self.g3.caminho(3))
        self.assertEqual(set(self.g4.caminho(2)), set(['A', 'a3', 'C', 'a2', 'B']))
        self.assertEqual(set(self.g5.caminho(1)), set(['A', 'a3', 'C']))
        self.assertEqual(set(self.g6.caminho(4)), set(['A', 'a2', 'E', 'a6', 'C', 'a5', 'D', 'a3', 'B']))
        self.assertEqual(set(self.g7.caminho(5)), set(['D', 'a4', 'E', 'a5', 'C', 'a6', 'A', 'a1', 'B', 'a7', 'G']))
        self.assertEqual(set(self.g8.caminho(1)), set(['CCC', 'a2', 'BBB']))
        self.assertEqual(set(self.g9.caminho(3)), set(['V1', 'a1', 'V2', 'a5', 'V5', 'a7', 'V3']))
        self.assertFalse(self.g11.caminho(9))
        self.assertEqual(set(self.g12.caminho(3)), set(['H', '2', 'J', '3', 'L', '5', 'K']))
        self.assertFalse(self.g13.caminho(0))

    def test_conexo(self):
        self.assertTrue(self.g1.conexo())
        self.assertTrue(self.g2.conexo())
        self.assertFalse(self.g19.conexo())
        self.assertFalse(self.g20.conexo())
        self.assertFalse(self.g5.conexo())
        self.assertTrue(self.g11.conexo()) # Dúvida se um laço com um só vértice é considerado conexo
        self.assertTrue(self.g12.conexo())
        self.assertTrue(self.g13.conexo())
        self.assertTrue(self.g14.conexo())
